...
> [!TIP]
> - The generic format works with Codex and other agents that use
>   `AGENTS.md` and `.agents/skills/`. Codex supports automatic skill
>   discovery.
> - If your agent does not support automatic skill discovery, instruct
>   it to read `AGENTS.md`.
